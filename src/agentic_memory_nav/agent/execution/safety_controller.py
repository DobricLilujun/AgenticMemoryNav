...
class SafetyError(RuntimeError):
    """Raised when a planned action violates safety limits."""

    pass


class SafetyController:
    """Enforce speed, timeout, and emergency-stop limits before execution."""
    ...
    def validate(self, intent: ActionIntent, state: Pose3D, collision: bool = False) -> None:
        """Reject the action if any safety gate fails."""
    ...
    def emergency_stop(self) -> None:
        """Latch the emergency stop; reset is required before any further motion."""
